...
function createStyles(c: C) {
  ...
  catItemActive: { borderColor: '#00658E', backgroundColor: '#E8F3FA' },
  catEmoji: { fontSize: 24 },
  catLabel: { fontSize: 12, fontWeight: '600', color: c.textSub },
  catLabelActive: { color: '#00658E' },
  emailRow: { flexDirection: 'row', gap: 10, marginBottom: 16 },
  addBtn: { backgroundColor: '#00658E', borderRadius: 12, paddingHorizontal: 16, paddingVertical: 12, justifyContent: 'center' },
  ...
  chipText: { fontSize: 13, color: '#00658E', fontWeight: '500' },
  ...
  methodCardActive: { borderColor: '#00658E', backgroundColor: '#E8F3FA' },
