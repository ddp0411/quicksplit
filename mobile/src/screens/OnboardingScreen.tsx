...
function createStyles(c: C) {
  return StyleSheet.create({
    ...
    title: { fontSize: 26, fontWeight: '800', color: c.text, textAlign: 'center', fontFamily: 'PlusJakartaSans_700Bold', marginBottom: 12 },
    ...
    dotActive: { width: 24, backgroundColor: '#0466C8' },
    btn: {
      backgroundColor: '#0466C8', borderRadius: 16, paddingVertical: 16,
