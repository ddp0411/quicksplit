...
function createStyles(c: C) {
  ...
  aiAvatar: { width: 28, height: 28, borderRadius: 14, backgroundColor: '#F0FDF4', alignItems: 'center', justifyContent: 'center' },
  ...
  chip: { backgroundColor: '#F0FDF4', borderRadius: 20, paddingHorizontal: 14, paddingVertical: 8, borderWidth: 1, borderColor: '#BBF7D0' },
  chipText: { fontSize: 13, color: '#1B4332', fontWeight: '600' },
