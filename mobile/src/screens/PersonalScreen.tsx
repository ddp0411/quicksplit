...
const CARDS = [
  {
    ...
    emoji: '🤖',
    title: 'AI Assistant',
    subtitle: 'Ask anything about your expenses',
    bg: '#EFF6FF',
    border: '#BFDBFE',
    accent: '#3B82F6',
  },
...
const s = StyleSheet.create({
  ...
  greeting: { fontSize: 24, fontWeight: '800', color: '#111827', fontFamily: 'PlayfairDisplay_700Bold' },
