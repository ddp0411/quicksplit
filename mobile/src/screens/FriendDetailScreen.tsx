  ...
  return (
    <SafeAreaView style={st.safe}>
      ...
      >
        {/* Profile hero */}
        <View style={st.hero}>
          <View style={[st.avatar, { backgroundColor: friend?.avatar_color ?? '#1B4332' }]}>
              ...
              friendSettlements.map((s: any) => {
                ...
                return (
                  <View key={s.id} style={st.settlRow}>
                    <View style={[st.settlIcon, { backgroundColor: isPaid ? '#F0FDF4' : '#FEF2F2' }]}>
...
function createStyles(c: C) {
  ...
  friendName: { fontSize: 20, fontWeight: '800', color: c.text, fontFamily: 'PlayfairDisplay_700Bold' },
