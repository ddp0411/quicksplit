...
echo "3. Start backend: cd backend && source venv/bin/activate && python manage.py migrate && python manage.py runserver 127.0.0.1:9000"
echo "4. Start Celery worker: cd backend && celery -A quicksplit worker --loglevel=info"
